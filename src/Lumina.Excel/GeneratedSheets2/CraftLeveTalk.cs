...
public partial class CraftLeveTalk : ExcelRow
{
    ...
    public override void PopulateData( RowParser parser, GameData gameData, Language language )
    {
        ...
        Unknown31 = parser.ReadOffset< int >( 64 );
        Unknown32 = parser.ReadOffset< byte >( 68 );
        Unknown33 = parser.ReadOffset< sbyte >( 69 );
        Unknown34 = parser.ReadOffset< sbyte >( 70 );
        Unknown35 = parser.ReadOffset< bool >( 71 );
        Talk = new SeString[6];
        for (int i = 0; i < 6; i++)
